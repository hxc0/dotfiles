...
" URL:          http://kippura.org/dorangedpage/
...
"
" After installation, use it with :colorscheme doranged.
...
"    colors doranged
"
" You can also do ":let g:doranged" then hit Ctrl-d or Tab to scroll through the
...
"   look strange.
"
"      let g:doranged_color_also_Ignore = 1
"
" * To get more contrast to the Visual selection, use
"
"      let g:doranged_alternate_Visual = 1
"
"   Note: this is enabled only if the old-style Visual
"   if used, see g:doranged_old_Visual
"
...
"
"      let g:doranged_alternate_Include = 1
"
" * To disable underlining for Labels, use
"
"      let g:doranged_disable_Label_underline = 1
"
" * Work-around to a Vim bug, it seems to misinterpret ctermfg and 234 and 237
"   as light values, and sets background to light for some people. If you have
"   this problem, use:
"
"      let g:doranged_force_dark_Background = 1
"
...
"
"      let g:doranged_unified_CursorColumn = 1
"
...
"    please enable:
"
"      let g:doranged_enable_TagHighlight=1
"
...
"
"      unlet g:doranged_alternate_Include
"   or 
"      let g:doranged_alternate_Include = 0
"
"
" That's it, enjoy!
"
...
if ! exists("g:doranged_high_Contrast")
    let g:doranged_high_Contrast = 0
endif

if ! exists("g:doranged_transparent")
    let g:doranged_transparent = 0
endif

if ! exists("g:doranged_color_also_Ignore")
    let g:doranged_color_also_Ignore = 0
endif

if ! exists("g:doranged_alternate_Error")
    let g:doranged_alternate_Error = 0
endif

if ! exists("g:doranged_force_dark_Background")
    let g:doranged_force_dark_Background = 0
endif

if ! exists("g:doranged_alternate_Visual")
    let g:doranged_alternate_Visual = 0
endif

if ! exists("g:doranged_alternate_Include")
    let g:doranged_alternate_Include = 0
endif

if ! exists("g:doranged_disable_Label_underline")
    let g:doranged_disable_Label_underline = 0
endif

if ! exists("g:doranged_unified_CursorColumn")
    let g:doranged_unified_CursorColumn = 0
endif

if ! exists("g:doranged_old_Visual")
    let g:doranged_old_Visual = 0
endif

if ! exists("g:doranged_enable_TagHighlight")
    let g:doranged_enable_TagHighlight = 0
endif
...
let g:colors_name="doranged"

hi Builtin         guifg=#ffd700 gui=bold                     ctermfg=220 cterm=bold 
hi Boolean         guifg=#dca3a3                              ctermfg=181
hi Character       guifg=#dca3a3 gui=bold                     ctermfg=181 cterm=bold
hi Comment         guifg=#7f9f7f gui=italic                   ctermfg=244 cterm=bold
hi Conditional     guifg=#f0dfaf gui=bold                     ctermfg=223 cterm=bold
hi Constant        guifg=#dca3a3 gui=bold                     ctermfg=192 cterm=bold
...
hi Exception       guifg=#c3bf9f gui=bold                     ctermfg=208 cterm=bold
hi Float           guifg=#c0bed1                              ctermfg=251
hi FoldColumn      guifg=#93b3a3 guibg=#3f4040
hi Folded          guifg=#93b3a3 guibg=#3f4040
hi Function        guifg=#efef8f                              ctermfg=227 cterm=bold
hi Identifier      guifg=#efdcbc                              ctermfg=215 cterm=none
...
hi Number          guifg=#8cd0d3                              ctermfg=81
...
hi Special         guifg=#cfbfaf                              ctermfg=228
hi SpecialKey      guifg=#9ece9e                              ctermfg=151
hi Statement       guifg=#e3ceab gui=none                     ctermfg=192 cterm=none
...
hi String          guifg=#cc9393                              ctermfg=222
...
hi Type            guifg=#dfdfbf gui=bold                     ctermfg=180 cterm=bold
...
hi SpellBad   guisp=#bc6c4c guifg=#dc8c6c  ctermfg=209 ctermbg=52
hi SpellCap   guisp=#6c6c9c guifg=#8c8cbc  ctermfg=103 ctermbg=52
hi SpellRare  guisp=#bc6c9c guifg=#bc8cbc  ctermfg=139 ctermbg=52
hi SpellLocal guisp=#7cac7c guifg=#9ccc9c  ctermfg=151 ctermbg=52

if exists("g:doranged_high_Contrast") && g:doranged_high_Contrast
    ...
    hi CursorLineNR  guifg=#f2f3bb guibg=#161616           ctermfg=208 ctermbg=240 cterm=bold
    if exists("g:doranged_unified_CursorColumn") && g:doranged_unified_CursorColumn
...
if exists("g:doranged_force_dark_Background") && g:doranged_force_dark_Background
...
if exists("g:doranged_transparent") && g:doranged_transparent
...
if exists("g:doranged_old_Visual") && g:doranged_old_Visual
    if exists("g:doranged_alternate_Visual") && g:doranged_alternate_Visual
...
if exists("g:doranged_alternate_Error") && g:doranged_alternate_Error
    " use more jumpy Error
    hi Error    guifg=#e37170 guibg=#664040 gui=bold  ctermfg=210 ctermbg=52 cterm=bold
else
    " default is something more doranged-compatible
    hi Error    guifg=#e37170 guibg=#3d3535 gui=bold  ctermfg=167 ctermbg=236 cterm=bold
endif

if exists("g:doranged_alternate_Include") && g:doranged_alternate_Include
    " original setting
...
if exists("g:doranged_disable_Label_underline") && g:doranged_disable_Label_underline
    hi Label    guifg=#dfcfaf                         ctermfg=187
else
    hi Label    guifg=#dfcfaf gui=underline           ctermfg=187 cterm=underline
endif

if exists("g:doranged_color_also_Ignore") && g:doranged_color_also_Ignore
...
if exists("g:doranged_enable_TagHighlight") && g:doranged_enable_TagHighlight
