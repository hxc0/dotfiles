...
"
" After installation, use it with :colorscheme hxc0.
...
"    colors hxc0
"
" You can also do ":let g:hxc0" then hit Ctrl-d or Tab to scroll through the
...
"   look strange.
"
"      let g:hxc0_color_also_Ignore = 1
"
" * To get more contrast to the Visual selection, use
"
"      let g:hxc0_alternate_Visual = 1
"
"   Note: this is enabled only if the old-style Visual
"   if used, see g:hxc0_old_Visual
"
...
"
"      let g:hxc0_alternate_Include = 1
"
" * To disable underlining for Labels, use
"
"      let g:hxc0_disable_Label_underline = 1
"
" * Work-around to a Vim bug, it seems to misinterpret ctermfg and 234 and 237
"   as light values, and sets background to light for some people. If you have
"   this problem, use:
"
"      let g:hxc0_force_dark_Background = 1
"
...
"
"      let g:hxc0_unified_CursorColumn = 1
"
...
"    please enable:
"
"      let g:hxc0_enable_TagHighlight=1
"
...
"
"      unlet g:hxc0_alternate_Include
"   or 
"      let g:hxc0_alternate_Include = 0
"
"
" That's it, enjoy!
"
...
if ! exists("g:hxc0_high_Contrast")
    let g:hxc0_high_Contrast = 0
endif

if ! exists("g:hxc0_transparent")
    let g:hxc0_transparent = 0
endif

if ! exists("g:hxc0_color_also_Ignore")
    let g:hxc0_color_also_Ignore = 0
endif

if ! exists("g:hxc0_alternate_Error")
    let g:hxc0_alternate_Error = 0
endif

if ! exists("g:hxc0_force_dark_Background")
    let g:hxc0_force_dark_Background = 0
endif

if ! exists("g:hxc0_alternate_Visual")
    let g:hxc0_alternate_Visual = 0
endif

if ! exists("g:hxc0_alternate_Include")
    let g:hxc0_alternate_Include = 0
endif

if ! exists("g:hxc0_disable_Label_underline")
    let g:hxc0_disable_Label_underline = 0
endif

if ! exists("g:hxc0_unified_CursorColumn")
    let g:hxc0_unified_CursorColumn = 0
endif

if ! exists("g:hxc0_old_Visual")
    let g:hxc0_old_Visual = 0
endif

if ! exists("g:hxc0_enable_TagHighlight")
    let g:hxc0_enable_TagHighlight = 0
endif
...
hi Special         guifg=#cfbfaf                              ctermfg=203
...
if exists("g:hxc0_high_Contrast") && g:hxc0_high_Contrast
    ...
    if exists("g:hxc0_unified_CursorColumn") && g:hxc0_unified_CursorColumn
...
if exists("g:hxc0_force_dark_Background") && g:hxc0_force_dark_Background
...
if exists("g:hxc0_transparent") && g:hxc0_transparent
...
if exists("g:hxc0_old_Visual") && g:hxc0_old_Visual
    if exists("g:hxc0_alternate_Visual") && g:hxc0_alternate_Visual
...
if exists("g:hxc0_disable_Label_underline") && g:hxc0_disable_Label_underline
    hi Label    guifg=#dfcfaf                         ctermfg=187
else
    hi Label    guifg=#dfcfaf gui=underline           ctermfg=187 cterm=underline
endif

if exists("g:hxc0_color_also_Ignore") && g:hxc0_color_also_Ignore
...
if exists("g:hxc0_enable_TagHighlight") && g:hxc0_enable_TagHighlight
